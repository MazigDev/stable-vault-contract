...
async function test() {
    ...
    // // ? deposit
    // await usdc.approve(vault.address, 0);
    // await usdc.approve(vault.address, 5_000_000_000_000);
    // await vault.deposit(5_000_000_000_000);

    // // // ? supply
    // await vault.supplyAaveV3(0, 5_000_000_000_000);
    // await vault.supplyCompoundV3(0, 400_000_000);
    console.log(await vault.balanceAaveV3((await vault.aaveV3Addresses(0))));
