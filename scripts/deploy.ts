...
async function test() {
    ...
    const compoundV2Addresses = ["0x8C3e3821259B82fFb32B2450A95d2dcbf161C24E"];
    const vaultDeploy = await upgrades.deployProxy(
        vaultFatory,
        [name, symbol, admin, admin, token, aaveV3Addresses, compoundV2Addresses, compoundV3Addresses],
